...
| `encode_ivtc.fish` | Encodes telecined 480i content (e.g. film-sourced cartoons) using inverse telecine + x265; when passed directories, outputs to `<dir>/converted/` in each — useful for batch processing multiple seasons at once |
